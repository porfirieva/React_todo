...
total_debtors = int(input('Введите количество должников: '))
cash_debtor = 0
for number in range(0, total_debtors, 5):
  print('Должник с номером', number)
  cash = int(input('Сколько должны? '))
  cash_debtor += cash
print('Общая сумма долга:', cash_debtor)